...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        products = [
            {'name_product':'Pioneer', 'description_product':'viper venom ddr5', 'category_product':category, 'price_product':1000000},
            {'name_product':'Kingston', 'description_product':'перепаянная и разогнанная ddr4', 'category_product':category, 'price_product':10000},
        ]
